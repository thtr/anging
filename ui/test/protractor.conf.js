...
* set environment variables to override config:
	export NODEPRIME_UI_URL='http://localhost:10000/'
	export NODEPRIME_UI_SELENIUM_ADDRESS='http://127.0.0.1:4444/wd/hub'
* 
...
*/
exports.config = {
  seleniumAddress: (process.env.NODEPRIME_UI_SELENIUM_ADDRESS || 'http://127.0.0.1:4444/wd/hub').trim().replace(/\/+$/,''),
  ...
  */
  ...
  baseUrl: (process.env.NODEPRIME_UI_URL || 'http://localhost:10001/').trim().replace(/\/+$/,'/'),
  framework: 'jasmine',
